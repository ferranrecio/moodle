...
$string['activitychoosertabmode'] = 'Activity chooser tabs (deprecated)';
$string['activitychoosertabmode_desc'] = "The activity chooser lists activities and resources for a teacher to add to their course. To add items to the Recommended tab, go to <a href='../course/recommendations.php'>Recommended activities</a>. This setting is deprecated and will be removed in a future version of Moodle.";
...
$string['aria:modulefavourite'] = 'Add {$a} activity to favourites';
$string['aria:moduleunfavourite'] = 'Remove {$a} activity from favourites';
...
$string['mod_purpose_other'] = 'Other';
$string['mod_purpose_other_help'] = 'Elements that could be added to the course with no defined purpose.';
