...
$string['activityisclosed_info'] = 'This activity is no longer available because the close date has passed.';
$string['activitylink'] = 'Permalink';
$string['activitynotopen'] = 'This activity is not yet open';
$string['activitynotopen_info'] = 'Come back later when the activity is available.';
$string['activitynotready'] = 'Activity not ready yet';
$string['activitynotready_info'] = 'Please come back later.';
...
$string['startbuildingactivity'] = 'Start building your activity';
