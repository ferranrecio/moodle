...
class standard_string_manager implements string_manager {
    ...
    /** @var array country codes defined in config */
    ...
    public function __construct(
        \core\strings\lang_config_helper $langconfighelper,
    ) {
        [
        ...
        $this->countrycodes = $langconfighelper->get_country_codes();
    ...
    public function get_list_of_countries($returnall = false, $lang = null) {
        ...
        if (!$returnall && !empty($this->countrycodes)) {
            $return = [];
