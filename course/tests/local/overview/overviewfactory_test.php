 ...
 * @covers     \core_course\local\overview\overviewfactory
 */
final class overviewfactory_test extends \advanced_testcase {
    #[\Override()]
    public static function setUpBeforeClass(): void {
        global $CFG;
        require_once($CFG->dirroot . '/course/tests/fixtures/wrongcm_activityoverview.php');
    ...
    public function test_create_exception(
        ...
        $this->expectExceptionMessageMatches("/.* must extend core_course\\\\activityoverviewbase.*/");
