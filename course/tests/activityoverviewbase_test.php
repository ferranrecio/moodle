 ...
 * @covers     \core_course\activityoverviewbase
 */
final class activityoverviewbase_test extends \advanced_testcase {
    ...
    public function test_get_name_overview(): void {
        ...
        $this->assertInstanceOf(\core_course\output\local\overview\activityname::class, $result->get_content());
    }
    ...
    public function test_get_grades_overviews(): void {
        ...
        // Workshops have two grade items (and we don't want them indexed by id).
        ...
        // Validate workshop gradeitems.
        $cm = $modinfo->get_cm($workshop->cmid);
        $overview = new \core_course\fake_activityoverview($cm);
        $result = $overview->get_grades_overviews();
        $this->assertCount(2, $result);
        $this->assertEquals($workshopitems[0]->get_name(), $result[0]->get_name());
        $this->assertEquals(77, $result[0]->get_value());
        $this->assertEquals('77.00', $result[0]->get_content());
        $this->assertEquals($workshopitems[1]->get_name(), $result[1]->get_name());
        $this->assertEquals(null, $result[1]->get_value());
        $this->assertEquals('-', $result[1]->get_content());
