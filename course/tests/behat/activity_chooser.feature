...
Feature: Display and choose from the available activities in course
  ...
  Scenario: Favourite a module in the activity chooser
    Given I open the activity chooser
    And I should not see "Favourites" in the "Add an activity or resource" "dialogue"
    And I click on "Add Assignment activity to favourites" "button" in the "Add an activity or resource" "dialogue"
    And I should see "Favourites" in the "Add an activity or resource" "dialogue"
    When I click on "Favourites" "link" in the "Add an activity or resource" "dialogue"
  ...
  Scenario: Add a favourite module and check it exists when reopening the chooser
    Given I open the activity chooser
    And I click on "Add Assignment activity to favourites" "button" in the "Add an activity or resource" "dialogue"
    And I click on "Add Forum activity to favourites" "button" in the "Add an activity or resource" "dialogue"
    And I should see "Favourites" in the "Add an activity or resource" "dialogue"
    ...
    And I click on "Favourites" "link" in the "Add an activity or resource" "dialogue"
  ...
  Scenario: Add a favourite and then remove it whilst checking the tabs work as expected
    Given I open the activity chooser
    And I should not see "Favourites" in the "Add an activity or resource" "dialogue"
    When I click on "Add Assignment activity to favourites" "button" in the "Add an activity or resource" "dialogue"
    # The favourite tab should appear once the user stars an activity.
    Then I should see "Favourites" in the "Add an activity or resource" "dialogue"
    And I click on "Favourites" "link" in the "Add an activity or resource" "dialogue"
    And I click on "Remove Assignment activity from favourites" "button" in the "favourites" "core_course > Activity chooser tab"
  ...
  Scenario: The teacher can undo a unfavourite action done in the activity chooser favourites tab
    ...
    And I click on "Remove Assignment activity from favourites" "button" in the "favourites" "core_course > Activity chooser tab"
    Then I should see "Assignment" in the "favourites" "core_course > Activity chooser tab"
    And I click on "Add Assignment activity to favourites" "button" in the "favourites" "core_course > Activity chooser tab"
  ...
  Scenario: Teacher gets the base case for the Activity Chooser tab mode
    ...
    And I should see "Assignment" in the "assessment" "core_course > Activity chooser tab"
    And I should not see "Book" in the "assessment" "core_course > Activity chooser tab"
    # Collaboration tab.
    And I click on "Collaboration" "link" in the "Add an activity or resource" "dialogue"
    And I should see "Forum" in the "collaboration" "core_course > Activity chooser tab"
    And I should not see "Book" in the "collaboration" "core_course > Activity chooser tab"
    # Communication tab.
    And I click on "Communication" "link" in the "Add an activity or resource" "dialogue"
    And I should see "Choice" in the "communication" "core_course > Activity chooser tab"
    And I should not see "Book" in the "communication" "core_course > Activity chooser tab"
    # Resources tab.
    And I click on "Resources" "link" in the "Add an activity or resource" "dialogue"
    And I should see "Book" in the "content" "core_course > Activity chooser tab"
    And I should not see "Choice" in the "content" "core_course > Activity chooser tab"
    # Interactive content tab.
    And I click on "Interactive content" "link" in the "Add an activity or resource" "dialogue"
    And I should see "Lesson" in the "interactivecontent" "core_course > Activity chooser tab"
    And I should not see "Book" in the "interactivecontent" "core_course > Activity chooser tab"
