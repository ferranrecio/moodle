...
class behat_course extends behat_base {
     ...
     *
     * @Given I add a :activity to course :coursefullname section :sectionnum and I fill the form with:
     * @Given I add an :activity to course :coursefullname section :sectionnum and I fill the form with:
    ...
    public function i_add_to_course_section_and_i_fill_the_form_with($activity, $coursefullname, $section, TableNode $data) {
        ...
        $this->execute("behat_course::i_add_to_course_section",
            array($this->escape($activity), $this->escape($coursefullname), $this->escape($section))
        );
     ...
     *
     * @Given I add a :activity to course :coursefullname section :sectionnum
     * @Given I add an :activity to course :coursefullname section :sectionnum
