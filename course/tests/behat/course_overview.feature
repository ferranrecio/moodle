...
Feature: Users can access the course activities overview page
  ...
  Scenario: Teacher can navigate to the course overview page
    ...
    And I should see "View all the activities in this course, including key details like due date and updates."
  ...
  Scenario: Course overiew shows a table with all resources
    Given the following "activities" exist:
      | activity        | course | name        |
      | book            | C1     | Activity 1  |
