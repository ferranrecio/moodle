...
class overviewitem {
     ...
     * @param bool $important Whether the item is important and must be displayed even on small screens.
    ...
    public function __construct(
        ...
        /** @var bool whether the item is important and must be displayed event in small screens */
    ...
    /**
     * Determines whether the item is important.
     *
     * Important items will be displayed, even in small screens.
     *
     * @return bool
     */
     ...
     */
    public function set_content(string|renderable $content): void {
    ...
    /**
     * Define if the item is considered important.
     *
     * @param int|string|bool|null $value
     */
