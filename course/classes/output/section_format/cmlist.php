...
class cmlist implements renderable, templatable, customtemplate {
    ...
    /**
     * Return a data of a specific item.
     *
     * Course formats can override this method to chande the specific cm list item data.
     *
     * @param \renderer_base $output the output renderer
     * @param completion_info $completioninfo the course completion info
     * @param cm_info $mod the coure module of the item
     * @return stdClass the item data
     */
    protected function export_list_item(\renderer_base $output, completion_info $completioninfo, cm_info $mod): stdClass {
