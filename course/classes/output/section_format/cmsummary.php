 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class cmsummary implements renderable, templatable, customtemplate {

    /** @var course_format the course format class */
    protected $format;

    /** @var course_format the course section */
    protected $section;
    ...
    public function get_template(): string {
        return 'core_course/local/section_format/cmsummary';
    ...
    public function export_for_template(\renderer_base $output): stdClass {
        ...
        $data->summary = get_string('progresstotal', 'completion', $data);
