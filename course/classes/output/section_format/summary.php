 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class summary implements renderable, templatable, customtemplate {
    ...
    public function get_template(): string {
        return 'core_course/local/section_format/summary';
    ...
    public function export_for_template(\renderer_base $output): stdClass {
        ...
        if ($section->uservisible || $section->visible) {
            $data->summarytext = $this->format_summary_text($section);
        }
        return $data;
    }
     ...
     *
     * @param section_info $section The course_section
     * @return string HTML to output.
     */
    public function format_summary_text(section_info $section): string {
