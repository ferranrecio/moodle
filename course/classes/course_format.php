...
abstract class course_format {
    ...
    protected $format;
    /** @var stdClass data for course object, please use {@link course_format::get_course()} */
    protected $course = false;
    /** @var array caches format options, please use {@link course_format::get_format_options()} */
    ...
    /** @var course_modinfo the current course modinfo, please use {@link course_format::get_modinfo()} */
     ...
     * {@link course_format::create_edit_form_elements()} (calls this method with $foreditform = true)
     ...
     *
     * See {@link course_format::course_format_options()} for return array definition.
     *
     * Additionally section format options may have property 'cache' set to true
     * if this option needs to be cached in {@link get_fast_modinfo()}. The 'cache' property
     * is recommended to be set only for fields used in {@link course_format::get_section_name()},
     * {@link course_format::extend_course_navigation()} and {@link course_format::get_view_url()}
     *
     ...
     * additional fields defined in {@link course_format::section_format_options()}
     *
     ...
     * standard footer)
     *
     * See {@link course_format::course_header()} for usage
     *
     * @return null|renderable null for no output or object with data for plugin renderer
     */
