...
function include_course_ajax($course, $usedmodules = array(), $enabledmodules = null, $config = null) {
    ...
    // All the new editor elements will be loaded adter the course is presented and
    ...
    // TODO: add a way to indicate the plugin needs the legacy libraries (and get a deprecation message).
