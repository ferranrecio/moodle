...
class get_overview_information extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'modname' => new external_value(PARAM_ALPHANUMEXT, 'The module name', VALUE_REQUIRED),
        ]);
    }
    ...
    public static function execute(int $courseid, string $modname): stdClass {
        ...
        /** @var \core_courseformat\output\local\overview\overviewtable $overviewtable */
        $overviewtable = new $overvietableclass($course, $modname);

        $exportedcontent = $overviewtable->export_for_external($renderer);
        $exporter = new overviewtable_exporter($exportedcontent, ['context' => $context]);
    ...
    public static function execute_returns(): external_single_structure {
        return overviewtable_exporter::get_read_structure();
    }
}
