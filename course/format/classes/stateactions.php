...
class stateactions {
     ...
     * @return int[] the array of seciton ids sorted by section number
     */
    protected function sort_cm_ids_by_course_position(
        ...
        // throw new moodle_exception(print_r($cmposition, true) . print_r($cmids, true) . print_r($sorting, true));
        return $cmids;
    }
    ...
    /**
     * Checks related to course modules: all given cm exist and the user has some capabilities.
     *
