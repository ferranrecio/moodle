...
Feature: Verify activity visibility interface.
  ...
  Scenario: Teacher can hide an activity using the actions menu.
    ...
    And I click on "Availability" "menuitem" in the "Activity sample 1" "core_courseformat > Activity actionmenu"
    And I click on "Hide on course page" "link" in the "Activity sample 1" "core_courseformat > Activity actionmenu"
  ...
  Scenario: Teacher can show an activity using the actions menu.
    ...
    And I click on "Availability" "menuitem" in the "Activity sample 2" "core_courseformat > Activity actionmenu"
    And I click on "Show on course page" "link" in the "Activity sample 2" "core_courseformat > Activity actionmenu"
  ...
  Scenario: Teacher can make available but not shown an activity using the actions menu.
    ...
    When I open "Activity sample 2" actions menu
    And I click on "Availability" "menuitem" in the "Activity sample 2" "core_courseformat > Activity actionmenu"
    And I click on "Make available but don't show on course page" "link" in the "Activity sample 2" "core_courseformat > Activity actionmenu"
    Then I should not see "Hidden from students" in the "Activity sample 2" "activity"
