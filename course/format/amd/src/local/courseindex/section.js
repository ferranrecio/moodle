...
export default class Component extends DndSection {
    ...
    _refreshPageItem({element, state}) {
        ...
        const section = state.section.get(this.id);
        const isDifferentSection = element.pageItem.sectionId !== this.id && this.isPageItem;
        const isNotSectionTypeAndIndexExpanded = element.pageItem.type !== 'section' && !section.indexcollapsed;

        if (isDifferentSection || isNotSectionTypeAndIndexExpanded) {
            this.pageItem = false;
