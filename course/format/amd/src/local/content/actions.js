...
export default class extends BaseComponent {
    ...
    /**
     * Return the ids repsented by this element.
     *
    ...
    async _requestDeleteSection(target, event) {
        ...
        if (sectionIds.length == 1) {
            ...
            bodyText = getString('confirmbulkdeletesections', 'core_courseformat');
        }
    ...
    async _requestCmDelete(target, event) {
        ...
        if (cmIds.length == 1) {
            ...
            bodyText = getString('confirmbulkdeletecms', 'core_courseformat');
        }
