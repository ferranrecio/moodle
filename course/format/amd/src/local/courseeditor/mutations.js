...
export default class {
     ...
     *
     * If the page item is is static means that it is not meant to change. This is important because
     * static page items has some special logic. For example, if a cm is the static page item
     * and it is inside a collapsed section, the course index will uncollapse the section to make it visible.
     *
     * @param {StateManager} stateManager the current state manager
     ...
     * @param {boolean|undefined} isStatic if the page item is is static
     */
