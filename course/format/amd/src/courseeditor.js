 ...
 *
 * The backend cache state revision is a combination of the course->cacherev and the
 * current user course preferences and completion state. The backend change that number
...
export const setViewFormat = (courseId, setup) => {
    ...
    // Caches are disabled in edit mode.
    if (!setup.editing) {
