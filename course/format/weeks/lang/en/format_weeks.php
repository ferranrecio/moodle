...
$string['finalweek_explanation'] = 'Pick one day of the last week you need in the course. Weeks will be automatically created or removed to align with the selected date.';
$string['finalweek_merge'] = 'Content of weeks after this date';
