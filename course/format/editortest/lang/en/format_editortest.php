...
$string['pluginname'] = 'Course Editor Test';
$string['pluginname_help'] = 'Automathed test for course editor.';
...
$string['privacy:metadata'] = 'Example plugin does not store any personal data';
