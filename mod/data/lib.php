 ...
 * @todo MDL-75189 Final deprecation in Moodle 4.4.
...
function data_view($data, $course, $cm, $context) {
    global $CFG;
    debugging('data_print_template is deprecated. Use mod_data\\manager::set_module_viewed instead', DEBUG_DEVELOPER);
