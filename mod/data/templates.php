...
if (!$DB->count_records('data_fields', ['dataid' => $instance->id])) {
...
if (empty($instance->addtemplate) and empty($instance->singletemplate) and
    empty($instance->listtemplate) and empty($instance->rsstemplate)) {
