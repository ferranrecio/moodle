...
class mod_h5pactivity_attempt_testcase extends \advanced_testcase {
     ...
     *
     * @dataProvider test_save_statement_data
     ...
     * @return array
     */
    public function test_save_statement_data(): array {
        return [
     ...
     *
     * @dataProvider test_delete_all_attempts_data
     ...
     * @return array
     */
    public function test_delete_all_attempts_data(): array {
        return [
    ...
    /**
     * Return a valid xAPI statement.
     * @param bool $definition if has to include definition
     * @param bool $result if has to include results
     * @return stdClass
     */
    private function generate_statement(bool $definition, bool $result): stdClass {
