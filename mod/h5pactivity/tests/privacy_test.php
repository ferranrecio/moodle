...
namespace mod_h5pactivity\tests;
...
use \mod_h5pactivity\privacy\provider;
...
class mod_h5pactivity_privacy_testcase extends provider_testcase {
    ...
    protected function h5pactivity_setup_test_scenario_data(): void {
        ...
        $this->student0 = $student = $this->getDataGenerator()->create_and_enrol($course, 'student');

        // Create student1 with 2 attempts.
        $this->student1 = $student = $this->getDataGenerator()->create_and_enrol($course, 'student');
        $params = ['cmid' => $cm->id, 'userid' => $this->student1->id];
        $generator->create_content($activity, $params);
        $generator->create_content($activity, $params);

        // Create student2 with 2 attempts.
        $this->student2 = $student = $this->getDataGenerator()->create_and_enrol($course, 'student');
