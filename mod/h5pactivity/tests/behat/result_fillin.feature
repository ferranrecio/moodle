...
Feature: View fill the blanks attempt report
  ...
  Scenario: View attempt in a fill the blanks content
    ...
    Then I should see "brigadoon" in the "brasilia" "table_row"
    Then "Your answer is incorrect" "icon" should exist in the "brasilia" "table_row"
    Then I should see "emerald city" in the "washington" "table_row"
    Then I should see "narnia" in the "berlin" "table_row"
    Then "Your answer is incorrect" "icon" should exist in the "berlin" "table_row"
    Then "Your answer is correct" "icon" should exist in the "canberra" "table_row"
