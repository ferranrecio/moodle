...
function xmldb_h5pactivity_upgrade($oldversion) {
    ...
    if ($oldversion < 2020022501) {
        ...
        // Define field displayoptions to be added to h5pactivity.
        $table = new xmldb_table('h5pactivity');
        $field = new xmldb_field('displayoptions', XMLDB_TYPE_INTEGER, '4', null, XMLDB_NOTNULL, null, '0', 'grade');
        ...
        $table->add_field('h5pacivityid', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null);
        ...
        $table->add_key('fk_h5pacivityid', XMLDB_KEY_FOREIGN, ['h5pacivityid'], 'h5pacivity', ['id']);

        // Adding indexes to table h5pactivity_attempts.
        $table->add_index('timecreated', XMLDB_INDEX_NOTUNIQUE, ['timecreated']);
        $table->add_index('h5pacivityid-timecreated', XMLDB_INDEX_NOTUNIQUE, ['h5pacivityid', 'timecreated']);
        $table->add_index('h5pacivityid-userid', XMLDB_INDEX_NOTUNIQUE, ['h5pacivityid', 'userid']);
        ...
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('attemptid', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null);
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id']);
        $table->add_key('fk_attemptid', XMLDB_KEY_FOREIGN, ['attemptid'], 'h5pacivity_attempts', ['id']);
        ...
        upgrade_mod_savepoint(true, 2020022501, 'h5pactivity');
    }
