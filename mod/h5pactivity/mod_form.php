...
class mod_h5pactivity_mod_form extends moodleform_mod {
    ...
    public function definition(): void {
        ...
        $mform->addElement('checkbox', 'enabletracking',  get_string('enabletracking', 'mod_h5pactivity'));
        $mform->addHelpButton('enabletracking', 'enabletracking', 'mod_h5pactivity');
        $mform->setDefault('enabletracking', true);
        ...
        $mform->hideIf('grademethod', 'enabletracking', 'notchecked');
