...
$string['result_choice'] = 'Choice';
$string['result_fill-in'] = 'Fill-in text';
$string['result_fill-in_gap'] = 'Gap #{$a}';
$string['result_interaction'] = 'Interaction {$a->number}: {$a->title}';
$string['result_long-fill-in'] = 'Essay';
$string['result_matching'] = 'Matching choice';
$string['result_other'] = 'Unknown interaction type';
$string['result_sequencing'] = 'Sequencing';
...
$string['result_true-false'] = 'True-false';
