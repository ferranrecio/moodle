...
abstract class backup_plan_dbops extends backup_dbops {
    ...
    /**
     * Given a course-module id, returns the full course_module record.
     * @param int $cmid
     * @return stdClass|null
     */
    public static function get_module_from_id($cmid): ?stdClass {
        global $DB;
        return ($DB->get_record('course_modules', ['id' => $cmid])) ?: null;
    }
