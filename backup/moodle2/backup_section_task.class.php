...
class backup_section_task extends backup_task {
    ...
    public function build() {
        ...
        if ($this->get_delegated_cm()) {
            ...
            // $this->add_setting(new backup_section_generic_setting(
            //     backup::VAR_SECTIONDELEGATECMID,
            //     base_setting::IS_INTEGER,
            //     $this->get_delegated_cm()
            // ));
            // $this->add_setting(new backup_activity_generic_setting(
            //     backup::VAR_MODNAME,
            //     base_setting::IS_TEXT,
            //     str_replace('mod_', '', $this->section->component)
            // ));
        }
...
// Protected API starts here
    ...
    protected function define_settings() {
        ...
        // // Add delegated section dependencies.
        // // if ($this->setting_exists(backup::VAR_MODNAME) && $delegatedcmid) {
        // if ($delegatedcmid) {
        //     $modname = str_replace('mod_', '', $this->section->component);
        //     $settingname = $modname . '_' . $delegatedcmid . '_' . 'included';
    ...
    protected function add_section_included_setting(string $settingprefix): section_backup_setting {
        ...
        // $sectionincluded->set_subsection($delegatedcmid !== null);
    ...
    protected function add_section_userinfo_setting(string $settingprefix, section_backup_setting $includefield): section_backup_setting {
        ...
        // $section_userinfo->set_subsection($delegatedcmid !== null);
