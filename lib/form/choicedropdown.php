...
class MoodleQuickForm_choicedropdown extends HTML_QuickForm_select implements templatable {
    ...
    var $dropdownwidth = status::WIDTH['small'];
     ...
     * @param string $value optional value (in case it is not defined in the choicelist)
     * @return bool
     */
    function load(&$choice, $value = null, $unused2 = null, $unused3 = null, $unused4 = null) {
        $this->choice = $choice;
