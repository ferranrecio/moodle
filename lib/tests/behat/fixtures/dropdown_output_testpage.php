...
echo "<h3>Basic example</h3>";
$choice = new core\output\choice('Dialog content');
$choice->add_option('option1', 'Option 1', ['description' => 'Option 1 description']);
$choice->add_option('option2', 'Option 2', [
    'description' => 'Option 2 description',
    'icon' => new pix_icon('t/hide', 'Eye icon')
]);
$choice->add_option('option3', 'Option 3', ['icon' => new pix_icon('t/show', 'Eye icon')]);
