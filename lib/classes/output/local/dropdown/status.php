...
class status extends dialog {
     ...
     * @param choice $choice the coice object
     * @param array $definition an optional array of the element definition
     */
    public function __construct(string $buttoncontent, choice $choice, array $definition = [])
    {
        parent::__construct($buttoncontent, '', $definition);
        $this->set_choice($choice);
    }
     ...
     */
    public function set_choice(choice $choices) {
