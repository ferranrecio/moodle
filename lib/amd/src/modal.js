...
define([
    ...
    /**
     * Generic footer button event dispatcher.
     *
     * @method dispatchActionEvent
     * @param {String} eventName The name of the event
     * @param {Object} [data] optional activate event data
     */
    Modal.prototype.dispatchActionEvent = function(eventName, data) {
        var actionEvent = $.Event(eventName);
        this.getRoot().trigger(actionEvent, this);
    ...
    Modal.prototype.registerCloseOnCancel = function() {
        ...
        this.getModal().on(CustomEvents.events.activate, this.getActionSelector('cancel'), function(e, data) {
            this.dispatchActionEvent(ModalEvents.cancel, data);
        }.bind(this));
    };
    ...
    Modal.prototype.registerCloseOnSave = function() {
        ...
        this.getModal().on(CustomEvents.events.activate, this.getActionSelector('save'), function(e, data) {
            this.dispatchActionEvent(ModalEvents.save, data);
        }.bind(this));
    };
    ...
    Modal.prototype.registerCloseOnDelete = function() {
        ...
        this.getModal().on(CustomEvents.events.activate, this.getActionSelector('delete'), function(e, data) {
            this.dispatchActionEvent(ModalEvents.delete, data);
        }.bind(this));
    };
