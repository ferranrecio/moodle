...
export default class {
    ...
    /**
     * Get all data from a state collection.
     *
     * Components access the state frequently. This convenience method is a shortcut to
     * this.reactive.state.stateManager.getAll method.
     *
     * @param {String} name the state object name
     * @return {Map} the state object found (indexed by id)
     */
    getAll(name) {
        return this.stateManager.getAll(name);
    }
