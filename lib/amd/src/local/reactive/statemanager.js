...
const StateManager = class {
     ...
     *
     * The state manager is meant to work independly with native JS events.
     ...
     *
     * This is a private method, use de publuc debounced "this.publishEvents" instead.
     */
    _publishEvents() {
 ...
 *
 * The proxied variable will thow an error if it is altered when the state manager is locked.
 *
 ...
 *  - add: a conveninent method to add an element without specifying the key (ID will be used a key).
 *  - loadValues: to add many elements at once wihout speciying keys (IDs will be used).
 *
