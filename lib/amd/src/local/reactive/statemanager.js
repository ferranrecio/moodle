...
export default class StateManager {
    ...
    addUpdateTypes(newfunctions) {
        for (const updatetype in newfunctions) {
            if (newfunctions.hasOwnProperty(updatetype) && typeof newfunctions[updatetype] === 'function') {
                this.updatetypes[updatetype] = newfunctions[updatetype].bind(newfunctions);
            }
        }
    }
