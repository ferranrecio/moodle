...
class BaseComponent {
     ...
     *
     * BaseComponent call this method when destroyComponent is called.
     */
    destroy() {
     ...
     * As components can be unregister and removed at any time, the BaseComponent provide
     ...
     *
     * Note that only listeners registered with the class addEventListener
     ...
     *
     * This method will remove the component target and unregister it from the
     * reactive module.
     */
    remove() {
        this.unregister();
     ...
     *
     * This method will disable the component logic and watchers but it won't remove
     * any HTML created by the component. However, it will trigger the destroy hook
     * to allow the component to clean parts of the interface.
     *
     */
    unregister() {
