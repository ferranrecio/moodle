 ...
 * @param {boolean|object} [options.pending=false] Whether to wrap the debounced method in a
 * pending promise or to use an existing one. If false, not pending promise is attached.
