    ...
    public static function execute_parameters() {
        return new external_function_parameters(
            [
                ...
                'activityId' => new external_value(PARAM_URL, 'xAPI activity ID IRI', VALUE_REQUIRED),
                'agent' => new external_value(PARAM_RAW, 'The xAPI agent json', VALUE_REQUIRED),
                'stateId' => new external_value(PARAM_ALPHAEXT, 'The xAPI state ID', VALUE_REQUIRED),
                'registration' => new external_value(PARAM_ALPHANUMEXT, 'The xAPI registration UUID', VALUE_OPTIONAL),
                'statedata' => new external_value(PARAM_RAW, 'json object with all the statements to post', VALUE_REQUIRED),
            ]
        );
    }
