 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_xapi_item_agent_testcase extends advanced_testcase {
     ...
     *
     * @dataProvider test_unspupported_create_provider
     * @param bool $usembox
     ...
     * @return  array
     */
    public function test_unspupported_create_provider() : array {
        return [
