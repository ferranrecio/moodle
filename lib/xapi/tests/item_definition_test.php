 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_xapi_item_definition_testcase extends advanced_testcase {

    /**
     * Test item_definition creation.
     *
     * @dataProvider test_creation_provider
    ...
    public function test_creation (string  $interactiontype): void {
        ...
        $data = (object) [
            'type' => helper::generate_iri('example', 'id'),
        ];
     ...
     * @return  array
     */
    public function test_creation_provider() : array {
        return [
            'No interactionType' => [''],
            'Choice' => ['choice'],
            'fill-in' => ['fill-in'],
