...
$string['testscenario_filedesc_content'] = 'The tool will execute the scenarios (or scenario outlines) in the file.
However, the file could include a scenarios with "cleanup" tag to remove the created data after the test. The cleanup
will be executed only if the "execute" setting is set to "Cleanup". To execute the cleanup
