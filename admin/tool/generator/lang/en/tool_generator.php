...
$string['execute_scenarios'] = 'Scenarios';
$string['execute_cleanup'] = 'Cleanup/Background';
...
$string['testscenario_filedesc'] = 'The upload feature files can only contain scenarios with core_data_generator steps or some specific steps that do not require selenium. All scenarios will be executed at once but background/cleanup steps will be ignored by default.';
$string['testscenario_filedesc_content'] = 'The tool will execute all the scenarios (or scenario outlines) in the file.
However, the file could include a "Cleanup" section to remove the created data after the test. The cleanup
will be executed only if the "execute" setting is set to "Cleanup/Background". To execute the cleanup
via CLI, you can use the --cleanup option.';
