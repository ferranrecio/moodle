...
Usage:
    php testscenario.php    [--feature=\"value\"] [--help]
...
$runner = new tool_behat\local\runner();

try {
    $runner->init();
} catch (Exception $e) {
    echo "Something is wrong with the behat setup.\n";
    echo "  Please,run \"php admin/tool/behat/cli/init.php\" from your Moodle root directory first.\n";
    exit(0);
}
