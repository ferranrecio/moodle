...
$string['runner_filedesc'] = 'The upload feature files can only contain scenarios with core_data_generator steps. It is not yet compatible with scenario outlines. All scenarios will be executed at once but background will be ignored.';
...
$string['runner_notready'] = 'Composer and behat libraries are not installed.<br><br>Please, execute this command to enable this tool: <strong>php admin/tool/behat/cli/testscenario.php</strong>';
$string['runner_steps'] = 'Testing scenario steps:';
$string['runner_scenatio_nosteps'] = 'This scenarios does not have any steps.';
