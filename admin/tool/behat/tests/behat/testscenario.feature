...
Feature: Create testing scenarios using generators
  ...
  Scenario: Create a testing scenario with a course enrolled users and activities
    ...
    When I upload "admin/tool/behat/tests/fixtures/testscenario/scenario.feature" file to "Feature file" filemanager
    And I press "Import"
  ...
  Scenario: Prevent creating a testing scenario with no steps to execute
    Given I log in as "admin"
    And I navigate to "Development > Create testing scenarios" in site administration
    When I upload "admin/tool/behat/tests/fixtures/testscenario/scenario_wrongempty.feature" file to "Feature file" filemanager
    And I press "Import"
  ...
  Scenario: Prevent creating a testing scenario with only background steps to execute
    Given I log in as "admin"
    And I navigate to "Development > Create testing scenarios" in site administration
    When I upload "admin/tool/behat/tests/fixtures/testscenario/scenario_wrongonlybackground.feature" file to "Feature file" filemanager
    And I press "Import"
    Then I should see "There are no steps to execute in the file."
  ...
  Scenario: Prevent creating a testing scenario with a wrong file format
    Given I log in as "admin"
    And I navigate to "Development > Create testing scenarios" in site administration
    When I upload "admin/tool/behat/tests/fixtures/testscenario/scenario_wrongformat.feature" file to "Feature file" filemanager
    And I press "Import"
  ...
  Scenario: Prevent creating a testing scenario with non generator steps
    Given I log in as "admin"
    And I navigate to "Development > Create testing scenarios" in site administration
    When I upload "admin/tool/behat/tests/fixtures/testscenario/scenario_wrongstep.feature" file to "Feature file" filemanager
    And I press "Import"
