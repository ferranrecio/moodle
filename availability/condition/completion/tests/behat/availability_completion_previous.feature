...
Feature: availability_completion
  ...
  Scenario: Test previous activity availability when modify completion tacking
    ...
    # Test thant if I disable completion tracking on Page2 section 5 depends on Page2.
    When I turn editing mode on
  ...
  Scenario: Test previous activities on empty sections
    ...
    # Test thant if I disable completion tracking on Page3 section 5 depends on Page2.
    When I turn editing mode on
