...
class activitieslist extends coursestructure {
     ...
     * @return void
     */
    public function __construct(\course_modinfo $modinfo, array $views, bool $showlastaccess = true, int $minlog = 0) {
        $this->showlastaccess = $showlastaccess;
