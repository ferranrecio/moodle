...
Feature: Updating a file in the content bank after using in a course
  ...
  Background:
    ...
    And the following "contentbank content" exist:
      ...
      | Course       | C1        | contenttype_h5p | admin | package.h5p | /h5p/tests/fixtures/arithmetic-quiz.h5p  |
  ...
  Scenario: Referenced files updates alias as well
    ...
    And I switch to "h5p-iframe" class iframe
    Then I should see "Solve these multiplication quizzes as fast as you can!"
    ...
    And I set the field "Intro" to "This is a new text"
    And I switch to the main frame
  ...
  Scenario: Copied files should not be updated if the original is edited
    ...
    And I switch to "h5p-iframe" class iframe
    And I switch to "h5p-iframe" class iframe
    And I should see "Solve these multiplication quizzes as fast as you can!"
    And I switch to the main frame
